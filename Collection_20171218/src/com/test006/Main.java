...
public class Main {
	...
	public static void main(String[] args) {
		...
		//LIFO,FIFO 컬렉션
		//LIFO(Last in First Out) : 나중에 넣은 자료가 먼저 빠져나올 수 있는 자료 구조 형태.대표적으로 Stack 클래스. 1,2,3 순으로 넣은 경우, 3,2,1 순으로 꺼낼 수 있다.
		//FIFO(First in First OUT) : 먼저 넣은 자료가 먼저 빠져나올 수 있는 자료 구조 형태.대표적으로 Queue 인터페이스. 1,2,3 순으로 넣은 경우, 1,2,3 순으로 꺼낼 수 있다.
